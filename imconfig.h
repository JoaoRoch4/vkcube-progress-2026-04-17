#pragma once
// vkcube Dear ImGui user config
// Included by every imgui translation unit via -DIMGUI_USER_CONFIG="imconfig.h"

// ── Test Engine ───────────────────────────────────────────────────────────────
#define IMGUI_ENABLE_TEST_ENGINE
// Coroutine scheduler using std::thread (no extra deps required).
